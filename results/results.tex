...
quiet well. However, the spread is denser within the consensus model and the
streamlines seems to be more aligned. 
...
dissimilar but the consensus model agrees. This could be a reason for the quiet
similar reconstructions of the right CST within the consensus selection model
and the consensus average model.
...
tract. Further, we have merged the left and right parts of each tract. 
...
the other models is significant, while both other models are not preferable to
each other. Therefore, we see our previous work further justified. 
