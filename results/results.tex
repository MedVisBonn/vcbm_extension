...
\begin{tabular}{p{4cm}p{1.5cm}}
	{}  & Time per streamline in seconds\\ \hline  
Average Model & 0,028\\
Consensus Average Model & 0,028\\
Selection Model & 0,023\\
Consensus Average Model & 0,025 \\
Low Rank Model &  0,043\\
Consensus Low Rank Model & 0,036\\


\end{tabular}

\caption{Comparison of the average time needed to create a single streamline of
...
For the different models the tracking needs a different amount of time due to
redoing the tracking if a streamline does meet the filter criteria. The
selection model has the fastest run time per streamline due to its restricted
