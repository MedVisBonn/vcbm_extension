\begin{abstract}
  ...
  bootstraps into a consensus model. We observe that, in most voxels,
  a traditional model selection strategy selects different models
  across bootstraps. In this sense, the bootstrap consensus also
  reduces model uncertainty. Either approach increases the accuracy of
  crossing fiber tractography in multiple subjects, but model
  averaging is much more efficient computationally. Combining both
  ideas achieved the highest overall accuracy.
